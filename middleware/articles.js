    ...
    if (route.params.id) {
        ...
        try {
            ...
            let request2 = await $axios.post(
                ...
                store.state.tokens.collections,
                {
                    fields: { header_text: 1, header_image: 1, name: 1, slug: 1, published:1 }, sort: { _created: -1 }, filter:{published:1}
                }
            );
        ...
        try {
            return await $axios
                .$post(
                    ...
                    {
                        fields: { header_text: 1, header_image: 1, name: 1, slug: 1, }, sort: { _created: -1 }, filter: {published:1}
                    }
                )
                .then(res => {
