<template>
	<div>
		...
		<Items :props="[data, '/plantshop/', 99]"></Items>
...
export default {
			...
			meta: [
				{
					hid: "description",
					name: "description",
					content: "See our library of plant species found around Cornwall",
				},
	...
	data() {
		return {
			...
			posts: [],
			error: "",
			name: "Plant Species Library | Green Lions Gardening",
		};
	},
