<template>
	<div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<u>
							<h3
								class="
									mbr-section-subtitle mbr-bold mbr-black mbr-light
									pb-3
									mbr-fonts-style
									display-5
								"
							>
								{{ data.article_list_title }}
							</h3>
						</u>
						<div
		...
		<!-- <Items :props="[display, '/services/', 99, 'Local Traders']"></Items> -->
		<Clients />
		<!-- <Contact /> -->
	</div>
</template>
